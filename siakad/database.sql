...
-- Sat 15 Nov 2025 10:59:56 PM WIB
...
CREATE TABLE IF NOT EXISTS `siakad_db`.`prodi` (
  ...
  `jenjang` VARCHAR(10) NULL DEFAULT NULL COMMENT 'Contoh: D3, D4, S1',
...
CREATE TABLE IF NOT EXISTS `siakad_db`.`mahasiswa` (
  ...
  INDEX `fk_mahasiswa_prodi_idx` (`id_prodi` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `siakad_db`.`dosen` (
  ...
  `nama` VARCHAR(45) NULL DEFAULT NULL,
  `keahlian` VARCHAR(45) NULL DEFAULT NULL,
  `password` VARCHAR(255) NULL DEFAULT NULL,
  `peran` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`nidn`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `siakad_db`.`mata_kuliah` (
  ...
  `id_prodi` INT NOT NULL,
  `nama_mk` VARCHAR(100) NULL DEFAULT NULL,
  `sks` INT NULL DEFAULT NULL,
  PRIMARY KEY (`kode_mk`),
  INDEX `fk_mk_prodi_idx` (`id_prodi` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `siakad_db`.`jadwal` (
  ...
  `kode_mk` VARCHAR(10) NULL DEFAULT NULL,
  `nidn` BIGINT NULL DEFAULT NULL,
  `hari` VARCHAR(50) NULL DEFAULT NULL,
  `jam` VARCHAR(20) NULL DEFAULT NULL COMMENT 'Contoh: 08:00 - 10:30',
  `ruang` VARCHAR(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id_jadwal`),
  INDEX `fk_jadwal_mk_idx` (`kode_mk` ASC) VISIBLE,
  INDEX `fk_jadwal_dosen_idx` (`nidn` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `siakad_db`.`krs` (
  ...
  `tahun_ajaran` VARCHAR(45) NULL DEFAULT NULL,
  `status_validasi` VARCHAR(100) NULL DEFAULT 'Menunggu',
  PRIMARY KEY (`id_krs`),
  INDEX `fk_krs_mahasiswa_idx` (`nim` ASC) VISIBLE,
  INDEX `fk_krs_jadwal_idx` (`id_jadwal` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `siakad_db`.`nilai` (
  ...
  `id_krs` INT NULL DEFAULT NULL,
  `nilai_huruf` VARCHAR(10) NULL DEFAULT NULL,
  `nilai_angka` FLOAT NULL DEFAULT NULL,
  PRIMARY KEY (`id_nilai`),
  INDEX `fk_nilai_krs_idx` (`id_krs` ASC) VISIBLE,
